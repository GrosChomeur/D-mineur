...
def compute_cell_size():
    ...
    screen_w = fen.winfo_screenwidth()
...
def adjacent_zero(cellY, cellX):
    ...
    It continues to dig adjacent cells recursively until no more cells can be dug.
    
    A stack is used to keep track of cells that might need their surroundings to be dug.

    param cellX : x coordinate of the starting cell
    param cellY : y coordinate of the starting cell
    """
